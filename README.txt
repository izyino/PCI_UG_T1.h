Para facilitar o desenvolvimento de aplicações a serem hospedadas na placa PCI_UG_T1 e T2, foi criada uma biblioteca de nome PCI_UG_Tx.h, disponível em https://github.com/izyino/PCI_UG_Tx.h a qual dispõe das seguintes funções:
--------------------------------------------------------------------------------------------------------
