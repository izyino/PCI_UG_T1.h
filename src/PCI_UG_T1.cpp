...
void PCI_UG_T1::go()
{
  switch (xtipostep[k]) {
    ...
    case 4: PCI_UG_T1::move4(); break;   //NEMA17,    200 steps, only one mode
  }
}
...
void PCI_UG_T1::move4(){   //NEMA17, 200 steps, only one mode
  switch (xfase[k]) {
    case 0: PCI_UG_T1::writ(1,0,1,0); break;   //0x0A
    case 1: PCI_UG_T1::writ(0,1,1,0); break;   //0x06
    case 2: PCI_UG_T1::writ(0,1,0,1); break;   //0x05
    case 3: PCI_UG_T1::writ(1,0,0,1); break;   //0x09    
  }
}
